...
try:
    from pygaze._eyetracker.alea.alea import AleaTracker as OGAleaTracker
except:
    print("Failed to import pygaze._eyetracker.alea.AleaTracker")
    try:
        from alea import AleaTracker as OGAleaTracker
    except:
        print("Failed to import alea.AleaTracker")
        raise Exception("Could not import AleaTracker")
