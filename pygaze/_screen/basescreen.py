...
class BaseScreen:
    ...
    def draw_circle(self):
        ...
        colour    --    drawing colour colour: a RGB tuple, e.g. (255,0,0)
                    for red or (0,0,0) for black; or None for the
                    default foreground colour, self.fgc (default = None)
        pos        --    circle centre, a (x,y) position tuple or None for a
    ...
    def draw_fixation(self):
        ...
        colour    --    drawing colour colour: a RGB tuple, e.g. (255,0,0)
                    for red or (0,0,0) for black; or None for the
                    default foreground colour, self.fgc (default = None)
        pos        --    fixation centre, a (x,y) position tuple or None for
    ...
    def draw_image(self):
        ...
        pos        --    image centre position, an (x,y) position tuple or
